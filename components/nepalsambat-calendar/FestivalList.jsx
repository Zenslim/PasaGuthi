...
export default function FestivalList({ calendar }) {
  ...
  const festivals = calendar.filter(e =>
    e.festival && e.festival.trim() !== ''
  );
  ...
  return (
    <div className="max-w-3xl mx-auto p-4">
      ...
      <input
        ...
        placeholder="Search by festival name, month, or tithi..."
        value={query}
        ...
        return (
          <div key={idx} className="bg-white border-l-4 border-yellow-500 shadow mb-3 p-3 rounded-md">
            ...
            <p className="text-sm text-gray-700 mt-1">
              <strong>N.S.:</strong> {ns.year} {ns.month}{ns.fortnight} {ns.day}, {ns.tithi}, {ns.weekday}<br />
              <strong>B.S.:</strong> {bs.year} {bs.month} {bs.day}<br />
              <strong>Gregorian:</strong> {entry.gregorian}
            </p>
          </div>
        );
      })}
