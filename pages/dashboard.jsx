  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-900 to-black text-white p-6">
      <div className="max-w-md mx-auto border border-green-500 rounded p-6 shadow-lg">
        <h1 className="text-2xl font-bold text-center text-pink-400 mb-4">🌸 Welcome, {userData.name}</h1>
        {isEditing ? (
          <>
            ...
            <button onClick={handleSave} className="w-full bg-green-600 text-white py-2 rounded">💾 Save Changes</button>
          </>
        ) : (
          <>
            ...
            <button onClick={() => setIsEditing(true)} className="mt-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded">✏️ Edit Profile</button>
